...
export function AdminQuestionManager({ initialQuestions }: { initialQuestions: Question[] }) {
  ...
  const openNew = () => setEditing({ id: '', type: 'single', prompt: '', options: defaultOptions(), explanation: '', difficulty: 'easy', active: true })
